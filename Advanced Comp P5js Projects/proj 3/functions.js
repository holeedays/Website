...
function UpdateQ1() {
    ...
    Q1Slider.addEventListener("input", () => {
        ...
        storedValues.Q1 = Q1Slider; // store the value
        sessionStorage.setItem("storedValueQ1", storedValues.Q1.value);
...
function UpdateQ5() {
    ...
    Q5Slider.addEventListener("input", () => {
        ...
        storedValues.Q5 = Q5Slider; 
        sessionStorage.setItem("storedValueQ5", storedValues.Q5.value);
...
function UpdateQ6() {
    ...
    Q6Slider.addEventListener("input", () => {
        ...
        storedValues.Q6 = Q6Slider; 
        sessionStorage.setItem("storedValueQ6", storedValues.Q6.value);
...
function UpdateQ10() {
    ...
    Q10Slider.addEventListener("input", () => {
        ...
        storedValues.Q10 = Q10Slider; 
        sessionStorage.setItem("storedValueQ10", storedValues.Q10.value);
